 ...
 * Ejemplo HOOKS:
 * - useState()
 * - useContext(): Poder utilizar el contexto y pasarlo a contextos inferiores
 */
...
export default function MiComponenteConContexto() {
  ...
  return (
    <miContexto.Provider value={sessionData}>
        ...
        {/** Además, si se actualiza, los compnentes de aqui tambien se actualizan */}
